...
Referring to the 
https://github.com/spacecubics/scobc-a1-sample/blob/main/boards/shields/scobc_a1_dev/scobc_a1_dev.overlay[DTS overlay file for Development Board], 
it can be seen that `GPIO14` of the GPIO IP core is defined with the device name `user_sw_1`. +

...
The sample application is available in 
{scobc_a1_sample_blinky_url}[Blinky sample].
...
Referring to the {scobc_a1_dev_overlay_url}[DTS overlay file for Development Board], it can be seen that `GPIO15` of 
